 ...
 * @author Dell
 */
public class bucketSortGui extends javax.swing.JFrame {
    int myArray[];
    String iteration;
    String resultt;
    /**
     * Creates new form bucketSort
     */
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(bucketSortGui.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new bucketSortGui().setVisible(true);
            }
        });
    }
