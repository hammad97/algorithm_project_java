 ...
 * @author Dell
 */
public class quickSortGui extends javax.swing.JFrame {
    int myArray[];
    String iteration;
    String resultt;
    StringBuilder s1;
    StringBuilder s2;
    /**
     * Creates new form selectionSortGui
     */
    public quickSortGui() {
        initComponents();
    ...
    {
        int pivot=myArray[p];     //Breaking the myArray and taking starting point as pivot
        int i=p;
        int temp;
        for(int j=i+1;j<=q;j++)
        {
            if(pivot>myArray[j])          //pivots get compared with all elements after pivot if greater then swap occurs
            {
                ++i;
                temp=myArray[i];             
                myArray[i]=myArray[j];
        ...
        temp=myArray[i];    //Now we need final swap to swap our pivot with the which is lasly swapped in our above for loop.
        myArray[i]=myArray[p];
        myArray[p]=temp;
        return i;
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        s1=new StringBuilder (iteration);
        s2=new StringBuilder (resultt);        
        sort(0,count-1);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(quickSortGui.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
